...
function BlogCard({
  ...
  return (
    <motion.article
      ...
      custom={index}
      className="group flex flex-col rounded-2xl overflow-hidden bg-background border border-border shadow-sm hover:shadow-xl hover:border-purple-brand/30 dark:hover:border-purple-brand/20 transition-all duration-300 h-full"
    >
